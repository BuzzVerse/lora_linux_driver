...
lora_rx: lora_rx.o lora_driver.o bbb_api_impl.o # mqtt.o mqtt_pal.o
	$(CC) $(CFLAGS) -o ./build/lora_rx ./build/lora_rx.o ./build/lora_driver.o ./build/bbb_api_impl.o # ./build/mqtt.o ./build/mqtt_pal.o
