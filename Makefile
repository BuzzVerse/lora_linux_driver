...
lora_rx: lora_rx.o spi_io.o
	arm-linux-gnueabihf-gcc -static -o  ./build/lora_rx ./build/lora_rx.o ./build/spi_io.o

lora_tx: lora_tx.o spi_io.o
	arm-linux-gnueabihf-gcc -static -o ./build/lora_tx ./build/lora_tx.o ./build/spi_io.o
